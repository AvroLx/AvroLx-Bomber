...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.SuccessMessage("Avro was updated to the latest version")
        ...
        mesgdcrt.FailureMessage("Unable to update Avro.")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("Avro is up-to-date")

        mesgdcrt.GeneralMessage("Starting Avro")
